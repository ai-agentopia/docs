...
- **Domain knowledge** — client-scoped knowledge bases with document ingestion, runtime retrieval, and cited answers. Next: [production-grade hybrid retrieval](milestones/production-super-rag)
