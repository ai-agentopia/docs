...
<img className="block dark:hidden" src="/images/platform-overview-light.svg" alt="Agentopia platform overview — operator defines objective, solution architect plans, developer writes code, reviewer evaluates, governance enforces policy" />
<img className="hidden dark:block" src="/images/platform-overview-dark.svg" alt="Agentopia platform overview — operator defines objective, solution architect plans, developer writes code, reviewer evaluates, governance enforces policy" />
